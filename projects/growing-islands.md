...
layout: project
type: project
image: img/growing-islands/growing-islands-square.png
...
<img class="img-fluid" src="../img/growing-islands/growing-islands-header.png">
...
That turns out to be hard. Existing toolkits like CoastSat and CoastSeg were built for larger, more typical coastlines, and they struggle to distinguish a small sandy island from the atoll it sits on. Modern general-purpose models like SAM and YOLO can't ingest the multispectral bands that make satellite imagery so information-rich. And the imagery that is affordable and covers a long enough time range is low-resolution (10m or 30m per pixel), which makes the problem harder still.
...
- With only **5 training images**, the 300M model still hit **F1 = 0.96, IoU = 0.85**.
- Peak performance was **F1 ≈ 0.99, IoU ≈ 0.96** at 125 training images.
- The 600M model performed only marginally better than the 300M one, suggesting the extra compute isn't worth it for this task.

Practically, this means shoreline monitoring in data-poor regions like small island nations doesn't require large labeled datasets or expensive high-resolution imagery — a meaningful shift for the accessibility of geospatial AI in climate applications.

## Talks and publications

I have presented this work as first author at three conferences in 2025:

- **NeurIPS 2025**, Tackling Climate Change with AI Workshop — *Utilizing a Geospatial Foundation Model for Coastline Delineation in Small Sandy Islands.* [[paper]](https://arxiv.org/pdf/2511.10177)
- **ACM KDD 2025**, Fragile Earth AI Workshop — *Utilizing a Geospatial Foundation Model for Shoreline Detection in Small Sandy Islands.* [[paper]](https://ai4good.org/wp-content/uploads/2025/08/4.pdf)
- **Coastal GeoTools 2025** — *Novel AI Models for Shoreline Detection*, presented to an audience of coastal professionals from NOAA, FEMA, and USGS.

I also assisted in a related presentation of the Growing Islands project to the UN General Assembly in New York in September 2024.
...
- NeurIPS 2025 paper: [arXiv:2511.10177](https://arxiv.org/pdf/2511.10177)
